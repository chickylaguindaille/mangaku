...
if($_POST) {
	...
	if($r->rowCount() >= 1) {
		...
		if(password_verify($_POST['mdp'], $membre['mdp'])) {
			...
			$_SESSION['membre']['bio'] = $membre['bio'];
			$_SESSION['membre']['date_naissance'] = $membre['date_naissance'];
			$_SESSION['membre']['ville'] = $membre['ville'];
			$_SESSION['membre']['photo_profil'] = $membre['photo_profil'];
			$_SESSION['membre']['photo_couverture'] = $membre['photo_couverture'];
...
<html>
    ...
    <div class="returnArrow"><a href="./inscription.php"><img src="../images/return.svg" alt=""></a></div>
        <div class = boardConnexion2><form method="post">
            ...
            <br><br>
            <input type="submit" class="seconnecter" value="Se connecter"></div>
        </form>
    </div>
